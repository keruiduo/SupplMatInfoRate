...
no.cores <- max(c(detectCores()-2, 1), na.rm=TRUE); # use less than 2 of the cores in the system (this includes hyperthreded ones)
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
tmp1 <- icc(lmer(NS ~ 1 + (1 | Text) + (1 | Language)+ (1 | Speaker), data=info.rate.data))
knitr::kable(data.frame("f"=c("Text", "Language", "Speaker"), "ICC"=c(tmp1["Text"], tmp1["Language"], tmp1["Speaker"])), 
             digits=2, row.names=FALSE, col.names=c("Level-1 factor (f)", "ICC"), caption="ICC for model `NS ~ 1 + (1 | Text) + (1 | Language)+ (1 | Speaker)`.");

tmp1 <- icc(lmer(SR ~ 1 + (1 | Text) + (1 | Language)+ (1 | Speaker), data=info.rate.data))
knitr::kable(data.frame("f"=c("Text", "Language", "Speaker"), "ICC"=c(tmp1["Text"], tmp1["Language"], tmp1["Speaker"])), 
             digits=2, row.names=FALSE, col.names=c("Level-1 factor (f)", "ICC"), caption="ICC for model `SR ~ 1 + (1 | Text) + (1 | Language)+ (1 | Speaker)`.");

tmp1 <- icc(lmer(ShIR ~ 1 + (1 | Text) + (1 | Language)+ (1 | Speaker), data=info.rate.data))
knitr::kable(data.frame("f"=c("Text", "Language", "Speaker"), "ICC"=c(tmp1["Text"], tmp1["Language"], tmp1["Speaker"])), 
             digits=2, row.names=FALSE, col.names=c("Level-1 factor (f)", "ICC"), caption="ICC for model `ShIR ~ 1 + (1 | Text) + (1 | Language)+ (1 | Speaker)`.");

tmp1 <- icc(lmer(IR ~ 1 + (1 | Text) + (1 | Language)+ (1 | Speaker), data=info.rate.data))
knitr::kable(data.frame("f"=c("Text", "Language", "Speaker"), "ICC"=c(tmp1["Text"], tmp1["Language"], tmp1["Speaker"])), 
...
```{r SR_lmm, echo=F}
lmr0 <- lmer(SR ~ 1 + (1 | Text) + (1 | Language) + (1 | Speaker), data=info.rate.data);
lmr1 <- lmer(SR ~ 1 + (1 | Language) + (1 | Speaker), data=info.rate.data);
lmr2 <- lmer(SR ~ 1 + (1 | Text) + (1 | Speaker), data=info.rate.data);
lmr3 <- lmer(SR ~ 1 + (1 | Text) + (1 | Language), data=info.rate.data);
lmr4 <- lmer(SR ~ 1 + Sex + (1 | Text) + (1 | Language) + (1 | Speaker), data=info.rate.data);
lmr5 <- lmer(SR ~ 1 + Sex + (1 | Language) + (1 | Speaker), data=info.rate.data);
lmr6 <- lmer(SR ~ 1 + Sex + (1 | Text) + (1 | Speaker), data=info.rate.data);
lmr7 <- lmer(SR ~ 1 + Sex + (1 | Text) + (1 | Language), data=info.rate.data);
...
lmr <- lmer(SR ~ 1 + Sex +  (1|Text) + (1|Language) + (1|Speaker), data=info.rate.data)
# summary(lmr)
plot(lmr)
...
```{r IR_lmm, echo=F}
lmr0 <- lmer(IR ~ 1 + (1 | Text) + (1 | Language) + (1 | Speaker), data=info.rate.data);
lmr1 <- lmer(IR ~ 1 + (1 | Language) + (1 | Speaker), data=info.rate.data);
lmr2 <- lmer(IR ~ 1 + (1 | Text) + (1 | Speaker), data=info.rate.data);
lmr3 <- lmer(IR ~ 1 + (1 | Text) + (1 | Language), data=info.rate.data);
lmr4 <- lmer(IR ~ 1 + Sex + (1 | Text) + (1 | Language) + (1 | Speaker), data=info.rate.data);
lmr5 <- lmer(IR ~ 1 + Sex + (1 | Language) + (1 | Speaker), data=info.rate.data);
lmr6 <- lmer(IR ~ 1 + Sex + (1 | Text) + (1 | Speaker), data=info.rate.data);
lmr7 <- lmer(IR ~ 1 + Sex + (1 | Text) + (1 | Language), data=info.rate.data);
...
lmr <- lmer(IR ~ 1 + Sex +  (1|Text) + (1|Language) + (1|Speaker), data=info.rate.data)
#summary(lmr)
plot(lmr)
get_re_distrib(residuals(lmr), "Residuals")
get_re_distrib(ranef(lmr)$Text[,1], "Levels of Text as random effect")
...
d <- info.rate.data[,c("SR","Sex","Text","Language","Speaker")]; # use only the columns we actually need (avoid errors about NAs in other columns)
model.NO.no.modelled.sigma.SR <- gamlss(SR ~ 1 + Sex + random(Text) + random(Language) + random(Speaker), 
                                        data=d, 
...
wp(model.NO.no.modelled.sigma.SR, ylim.all=0.4)
...
d <- info.rate.data[,c("SR","Sex","Text","Language","Speaker")]; # use only the columns we actually need (avoid errors about NAs in other columns)
model.NO.SR <- gamlss(SR ~ 1 + Sex + random(Text) + random(Language) + random(Speaker), 
                      sigma.fo = ~ 1 + Sex + random(Text) + random(Language) + random(Speaker), 
                      data=d, 
                      family=NO(mu.link="identity"), 
                      control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800))
...
d <- info.rate.data[,c("IR","Sex","Text","Language","Speaker")]; # use only the columns we actually need (avoid errors about NAs in other columns)
model.NO.no.modelled.sigma.IR <- gamlss(IR ~ 1 + Sex + random(Text) + random(Language) + random(Speaker), 
                                        data=d, 
                                        family=NO(mu.link="identity"),
                                        control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800))
...
d <- info.rate.data[,c("IR","Sex","Text","Language","Speaker")]; # use only the columns we actually need (avoid errors about NAs in other columns)
model.NO.IR <- gamlss(IR ~ 1 + Sex + random(Text) + random(Language) + random(Speaker), 
                      sigma.fo = ~ 1 + Sex + random(Text) + random(Language) + random(Speaker), 
                      data=d, 
                      family=NO(mu.link="identity"), 
                      control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800))
...
Let's model SR with ID as an additional predictor (fixed effect).
...
d <- info.rate.data[,c("SR","ID","Sex","Text","Speaker")]; # use only the columns we actually need (avoid errors about NAs in other columns)
model.NO.SR.ID <- gamlss(SR ~ 1 + ID + Sex + random(Text) + random(Speaker), 
                         sigma.fo = ~ 1 + ID + Sex + random(Text) + random(Speaker), 
                         data=d, 
                         family=NO(mu.link="identity"), 
                         control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800))
...
lmer.SR.ID <- lmer(SR ~ 1 + ID + Sex + (1 | Text) + (1 | Speaker), data=info.rate.data)
anova(lmer.SR.ID)
```
...
```
**Speaker**
```{r SR_ID_re_sigma_lg, echo=FALSE}
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
sr.sex.age.lmer <-lmer(SR ~ Age * Sex + (1 | Text) + (1 | Language), data=info.rate.data);
summary(sr.sex.age.lmer);

ir.sex.age.lmer <-lmer(IR ~ Age * Sex + (1 | Text) + (1 | Language), data=info.rate.data);
...
info.rate.data.for.age <- subset(info.rate.data[,c("SR","IR","ID","Sex","Text","Language","Speaker","Age")], !is.na(Age)); # use only the columns we actually need (and remove the NAs)
...
model.NO.no.modelled.sigma.noage.SR <- gamlss(SR ~ 1 + Sex + random(Text) + random(Language) + random(Speaker), 
                                              data=info.rate.data.for.age, 
                                              family=NO(mu.link="identity"),
                                              control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800));
model.NO.no.modelled.sigma.age.SR <- gamlss(SR ~ 1 + Sex * Age + random(Text) + random(Language) + random(Speaker), 
                                            data=info.rate.data.for.age, 
                                            family=NO(mu.link="identity"),
                                            control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800));
model.NO.no.modelled.sigma.age.noint.SR <- gamlss(SR ~ 1 + Sex + Age + random(Text) + random(Language) + random(Speaker), 
                                                  data=info.rate.data.for.age, 
                                                  family=NO(mu.link="identity"),
                                                  control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800));
...
model.NO.noage.SR <- gamlss(SR ~ 1 + Sex + random(Text) + random(Language) + random(Speaker), 
                            sigma.fo = ~ 1 + Sex + random(Text) + random(Language) + random(Speaker), 
                            data=info.rate.data.for.age, 
                            family=NO(mu.link="identity"), 
                            control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800));
model.NO.age.SR <- gamlss(SR ~ 1 + Sex * Age + random(Text) + random(Language) + random(Speaker), 
                          sigma.fo = ~ 1 + Sex * Age + random(Text) + random(Language) + random(Speaker), 
                          data=info.rate.data.for.age, 
                          family=NO(mu.link="identity"), 
                          control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800));
model.NO.age.noint.SR <- gamlss(SR ~ 1 + Sex + Age + random(Text) + random(Language) + random(Speaker), 
                                sigma.fo = ~ 1 + Sex + Age + random(Text) + random(Language) + random(Speaker), 
                                data=info.rate.data.for.age, 
                                family=NO(mu.link="identity"), 
                                control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800));
...
model.NO.no.modelled.sigma.noage.IR <- gamlss(IR ~ 1 + Sex + random(Text) + random(Language) + random(Speaker), 
                                              data=info.rate.data.for.age, 
                                              family=NO(mu.link="identity"),
                                              control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800));
model.NO.no.modelled.sigma.age.IR <- gamlss(IR ~ 1 + Sex * Age + random(Text) + random(Language) + random(Speaker), 
                                            data=info.rate.data.for.age, 
                                            family=NO(mu.link="identity"),
                                            control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800));
model.NO.no.modelled.sigma.age.noint.IR <- gamlss(IR ~ 1 + Sex + Age + random(Text) + random(Language) + random(Speaker), 
                                                  data=info.rate.data.for.age, 
                                                  family=NO(mu.link="identity"),
                                                  control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800));
...
model.NO.noage.IR <- gamlss(IR ~ 1 + Sex + random(Text) + random(Language) + random(Speaker), 
                            sigma.fo = ~ 1 + Sex + random(Text) + random(Language) + random(Speaker), 
                            data=info.rate.data.for.age, 
                            family=NO(mu.link="identity"), 
                            control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800));
model.NO.age.IR <- gamlss(IR ~ 1 + Sex * Age + random(Text) + random(Language) + random(Speaker), 
                          sigma.fo = ~ 1 + Sex * Age + random(Text) + random(Language) + random(Speaker), 
                          data=info.rate.data.for.age, 
                          family=NO(mu.link="identity"), 
                          control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800));
model.NO.age.noint.IR <- gamlss(IR ~ 1 + Sex + Age + random(Text) + random(Language) + random(Speaker), 
                                sigma.fo = ~ 1 + Sex + Age + random(Text) + random(Language) + random(Speaker), 
                                data=info.rate.data.for.age, 
                                family=NO(mu.link="identity"), 
                                control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800));
...
model.NO.SR.ID.age <- gamlss(SR ~ 1 + ID + Sex * Age + random(Text) + random(Speaker), 
                             sigma.fo = ~ 1 + ID + Sex * Age + random(Text) + random(Speaker), 
                             data=info.rate.data.for.age, 
                             family=NO(mu.link="identity"), 
                             control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800))
model.NO.SR.ID.age.noint <- gamlss(SR ~ 1 + ID + Sex + Age + random(Text) + random(Speaker), 
                             sigma.fo = ~ 1 + ID + Sex + Age + random(Text) + random(Speaker), 
                             data=info.rate.data.for.age, 
                             family=NO(mu.link="identity"), 
                             control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800))
model.NO.SR.ID.noage <- gamlss(SR ~ 1 + ID + Sex + random(Text) + random(Speaker), 
                             sigma.fo = ~ 1 + ID + Sex + random(Text) + random(Speaker), 
                             data=info.rate.data.for.age, 
                             family=NO(mu.link="identity"), 
                             control = gamlss.control(n.cyc = 800, trace = FALSE), i.control=glim.control(bf.cyc = 800))
...
| Model         | Deviance                                                  | AIC                                     |
|---------------|-----------------------------------------------------------|-----------------------------------------|
| *Age* * *Sex* | `r round(deviance(model.NO.SR.ID.age,  what = "G"),1)`       | `r round(AIC(model.NO.SR.ID.age),1)`       |
| *Age* + *Sex* | `r round(deviance(model.NO.SR.ID.age.noint,  what = "G"),1)` | `r round(AIC(model.NO.SR.ID.age.noint),1)` |
| *Sex*         | `r round(deviance(model.NO.SR.ID.noage,  what = "G"),1)`     | `r round(AIC(model.NO.SR.ID.noage),1)`     |
...
lmer.SR.ID.age <- lmer(SR ~ 1 + ID + Sex * Age + (1 | Text) + (1 | Speaker), data=info.rate.data.for.age)
lmer.SR.ID.age.noint <- lmer(SR ~ 1 + ID + Sex + Age + (1 | Text) + (1 | Speaker), data=info.rate.data.for.age)
lmer.SR.ID.noage <- lmer(SR ~ 1 + ID + Sex + (1 | Text) + (1 | Speaker), data=info.rate.data.for.age)
```
...
| Model         | AIC                                    |
|---------------|----------------------------------------|
| *Age* * *Sex* | `r round(AIC(lmer.SR.ID.age),1)`       |
| *Age* + *Sex* | `r round(AIC(lmer.SR.ID.age.noint),1)` |
| *Sex*         | `r round(AIC(lmer.SR.ID.noage),1)`     |

Interestingly, here the best model (as suggested by AIC) is the one with both *Age* and *Sex* (but no interaaction), but, as can be seen below, actually the effect of *Age* is *not significant* (*p* = `r round(summary(lmer.SR.ID.age.noint)$coefficients["Age","Pr(>|t|)"],3)`), suggesting that, in fact, the best model is still the one not including *Age*:
```{r echo=FALSE}
summary(lmer.SR.ID.age.noint);
```
