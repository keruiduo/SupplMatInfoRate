...
This `Rmarkdown` script (and corresponding TAB-separated CSV input data file `InfoRateData(2017).csv` and the resulting `HTML` document) contain the full analysis and plotting code accompanying the paper *Human languages share an optimal information transmission rate*.
