...
With these, we the oral corpus contains `r nrow(info.rate.data)` texts read by `r length(speakers)` coming from `r length(languages)` languages and `r length(texts)` texts.
